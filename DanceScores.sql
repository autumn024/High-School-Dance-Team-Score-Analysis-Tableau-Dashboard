-- I deleted all null values within my tables -- 
...
-- I am now going to make the date of compeition the primary key -- 
...
-- I am rounding off the average scores to keep it clean. 
